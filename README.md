...
| [ LangChain + FastAPI Q&A Bot](./LangChain_+_FastAPI:_Semantic_Search_&_Q&A_System) | Embedding-based text Q&A system with a REST API | LangChain · OpenAI API · FastAPI · FAISS |
...
-  Built projects combining process automation and AI (HR bots, RAG pipelines, dashboards)
